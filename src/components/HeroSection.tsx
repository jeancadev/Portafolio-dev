      ...
      <div className="container mx-auto">
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="flex flex-col justify-center">
            <p className="text-blue mb-2 animate-fade-in opacity-0 [animation-delay:0.2s]">Hola, soy</p>
            <h1 className="text-4xl md:text-6xl font-bold mb-4 animate-fade-in opacity-0 [animation-delay:0.4s]">
              Desarrollador de Software
            </h1>
            <p className="text-xl text-muted-foreground mb-6 max-w-md animate-fade-in opacity-0 [animation-delay:0.6s]">
